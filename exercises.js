...
function makeCat(name, age) {
  ...
  return cat;// create a new object with a name property with the value set to the name argument
...
function multiplyMysteryNumberByFive(mysteryNumberObject) {
   return mysteryNumberObject.mysteryNumber * 5;// mysteryNumberObject has a property called mysteryNumber
...
/* can also do return ((user.email)? true:false): */
...
function addFriend(user, newFriend) {
  ...
  return user;// user has a property called friends that is an array
...
function setUsersToPremium(users) {
  ...
  return users;// users is an array of user objects.
...
/* user.posts[i],likes is the same*/ 
